...
class DatasetCatalog(object):
    ...
    DATASETS = {
        ...
        "kuzushiji_denoised_train_same_label": {
            "data_dir": "input/denoised_train",
            "train_ids": "input/train_images.list",
            "data_csv": "input/train.csv",
            "unicode_translation": "input/unicode_translation_only_train.csv",
            "label_type": "same",
            "ext_type": "png",
        },
        "kuzushiji_denoised_val_same_label": {
            "data_dir": "input/denoised_train",
            "train_ids": "input/val_images.list",
            "data_csv": "input/train.csv",
            "unicode_translation": "input/unicode_translation_only_train.csv",
            "label_type": "same",
            "ext_type": "png",
        },
        "kuzushiji_denoised_test_use_val_same_label": {
            "data_dir": "input/denoised_train",
            "train_ids": "input/val_images.list",
            "data_csv": "input/train.csv",
            "unicode_translation": "input/unicode_translation_only_train.csv",
        ...
        "kuzushiji_denoised_test": {
            "data_dir": "input/denoised_test",
