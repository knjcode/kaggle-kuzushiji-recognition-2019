...
if [ ! -e $model100000 ]; then
  echo "$model100000 not found. Please download this file first."
    ...
    if [ -e $prediction_test_060000 ]; then
        ...
        mv models/060000_val/inference/kuzushiji_test/predictions.pth $prediction_test_060000
    fi
    ...
    if [ -e $prediction_test_100000 ]; then
        ...
        mv models/100000_val/inference/kuzushiji_test/predictions.pth $prediction_test_100000
    fi
