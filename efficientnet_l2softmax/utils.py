# reimplementation of official tensorflow efficientnet
# support only 1channel grayscale input and L2-Constrained Softmax
...
def efficientnet(width_coefficient=None,
                 ...
                 dropout_rate=0.2,
                 drop_connect_rate=0.2, image_size=190, num_classes=4212):
